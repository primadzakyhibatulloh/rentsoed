...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Map<String, dynamic> getStatusVisuals(String status) {
    switch (status) {
      ...
      case 'Selesai': 
        return {'color': Colors.lightGreenAccent, 'icon': Icons.check_circle_outline};
      case 'Dibatalkan':
          ...
          : StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  return Center(child: Text("Terjadi kesalahan: ${snapshot.error}", style: GoogleFonts.poppins(color: Colors.redAccent)));
                }
      ...
      builder: (context, reviewSnapshot) {
        ...
        return Card(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: BorderSide(
              color: status == 'Menunggu Pembayaran' ? const Color(0xFFD4AF37) : Colors.transparent,
              width: 1.5,
            ),
          ),
          child: InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center, // Tambahkan crossAxisAlignment
                        children: [
                  ...
                  Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.center, // Center alignment vertikal
                    children: [
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            const Gap(6),
                            Flexible( // Pastikan teks yang panjang akan terpotong
                              child: Text(
    ...
    if (status == 'Menunggu Pembayaran') {
      return SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text("LANJUTKAN PEMBAYARAN", style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
      ...
      return SizedBox(
        ...
        child: hasReviewed 
          ? OutlinedButton.icon(
              ...
              icon: const Icon(Icons.check_circle_outline, size: 16, color: Colors.lightGreenAccent),
              label: Text("Ulasan Terkirim", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.lightGreenAccent)),
              style: OutlinedButton.styleFrom(side: BorderSide(color: Colors.lightGreenAccent.withOpacity(0.5))),
            )
          : OutlinedButton.icon(
              onPressed: () async {
              ...
              label: Text("BERI ULASAN", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: const Color(0xFFD4AF37))),
