  ...
  Future<void> _confirmAndDelete(
    ...
    final bool? shouldDelete = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            "Yakin ingin menghapus kategori '$categoryName'? Semua motor dengan kategori ini akan kehilangan relasinya!",
    ...
    if (shouldDelete == true) {
      try {
        ...
        String errorMessage =
            "Gagal menghapus. Pastikan tidak ada motor yang masih menggunakan kategori ini.";
        if (context.mounted) {
        ...
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final categoryName =
                  category['nama_kategori'] as String; // Nama kolom baru
              ...
              return ListTile(
                ...
                subtitle: category['ikon_url'] != null
                    ? Text(
                        "Ikon: Tersedia",
                        style: GoogleFonts.poppins(
                ...
                leading: category['ikon_url'] != null
                    ? CircleAvatar(
                        backgroundImage: NetworkImage(category['ikon_url']),
                        radius: 20,
                      )
