...
import 'package:rentsoed_app/features/customer/terms/terms_page.dart';
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildDrawerItem(Icons.local_offer, "Voucher & Promo", () {
                ...
                _buildDrawerItem(Icons.description, "Syarat & Ketentuan", () {
                  Navigator.pop(context);
                ...
                _buildDrawerItem(Icons.help_center, "Pusat Bantuan", () {
                  Navigator.pop(context);
                  _launchWhatsApp(); // Memanggil fungsi WhatsApp
                }),
                _buildDrawerItem(Icons.info_outline, "Tentang Rentsoed", () {
                  Navigator.pop(context);
                  showAboutDialog(
                    context: context,
                ...
                _buildDrawerItem(Icons.settings, "Pengaturan Profil", () {
